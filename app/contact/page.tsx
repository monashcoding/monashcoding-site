    ...
    <main className="min-h-screen bg-linear-to-b from-background to-secondary pt-32 flex flex-col items-center justify-center">
      <div className="max-w-[600px] w-full py-16 px-8 text-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            <div className="w-[50px] h-[50px] bg-gold-700/10 rounded-2xl flex items-center justify-center shrink-0">
            ...
            <div className="text-left sm:text-center">
              ...
              <div className="text-lg text-foreground font-medium">hello@monashcoding.com</div>
            </div>
          </motion.a>

          <motion.a
            href="https://discord.gg/monashcoding"
            target="_blank"
          ...
          >
            ...
            <div className="text-left sm:text-center">
              ...
              <div className="text-lg text-foreground font-medium">Join our community</div>
            </div>
          </motion.a>

          <motion.a
            href="https://maps.google.com/?q=Monash+University+Clayton"
            target="_blank"
            rel="noopener noreferrer"
            className="py-6 px-8 bg-white/50 border border-black/10 rounded-2xl flex items-center gap-6 no-underline transition-all duration-300 hover:bg-white/80 hover:border-gold-700/30 hover:-translate-y-0.5 sm:flex-col sm:text-center"
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <div className="text-left sm:text-center">
              ...
              <div className="text-lg text-foreground font-medium">Monash University, Clayton VIC</div>
            </div>
          </motion.a>
        </div>
