...
function StoryItem({ item }: { item: (typeof storyItems)[0] }) {
  ...
  return (
    <motion.div
      ...
      style={{ opacity, x }}
    >
      <div className="text-2xl font-semibold text-gold-700 min-w-[120px] sticky top-24 h-fit md:static">
        {item.year}
      </div>
            ...
            <div>
              ...
              <ul className="list-none p-0 m-0 space-y-3">
                <li>
                  <a
                    href="/"
                    className="text-black/60 no-underline transition-colors duration-300 hover:text-gold-700"
                  >
                    Home
                  </a>
                </li>
          ...
          <div className="flex justify-between items-center flex-wrap gap-4 pt-8 border-t border-black/10">
            ...
            <div className="flex gap-6">
              <a
                ...
                className="text-black/50 transition-colors duration-300 hover:text-gold-700"
              >
