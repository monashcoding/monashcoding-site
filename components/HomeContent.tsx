            ...
            <div>
              ...
              <ul className="list-none p-0 m-0 space-y-3">
                <li>
                  <a
                    href="/"
                    className="text-white/60 no-underline transition-colors duration-300 hover:text-gold-700"
                  >
                    Home
                  </a>
                </li>
          ...
          <div className="flex justify-between items-center flex-wrap gap-4 pt-8 border-t border-white/10">
            ...
            <div className="flex gap-6">
              <a
                ...
                className="text-white/50 transition-colors duration-300 hover:text-gold-700"
              >
