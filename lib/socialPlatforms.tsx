...
// 1. Add entry to SOCIAL_PLATFORMS
// 2. Create an icon component below
// 3. Add entry to PLATFORM_ICONS
// 4. Add entry to PLATFORM_LABELS
...
function DiscordIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="currentColor">
...
function TwitterIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="currentColor">
...
function WebsiteIcon({ size = 24, className }: IconProps) {
  return (
